...
* Vote on AI contributions [#1831](https://github.com/nodejs/TSC/issues/1831), [nodejs/node#62105](https://github.com/nodejs/node/pull/62105)
  ...
  * Fedor: I agree that honesty should be encouraged. (The question of sufficiency
    of the existing code review process) reminds me of the removal of "master/slave"
    terminology from the core. There is no technical reason not to use this terminology
    in the code, but at the same time saying that it is technically valid is not
    sufficient for our community in other ways. It resulted in Node.js to be more
    inclusive long term. Historically measuring only technical merits is insufficient
    for large project. OpenJS encourages the use of AI given that statement in the AI policy.
  * ...
